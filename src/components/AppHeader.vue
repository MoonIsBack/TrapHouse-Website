...
import { useNavHighlight } from '@/composables/useNavHighlight'
...
// Die gleitende Fläche hinter Hover- und aktivem Link, siehe
// useNavHighlight.js — dort auch, warum sie ein eigenes Composable ist.
const {
  desktopNavRef,
  highlightVisible,
  highlightX,
